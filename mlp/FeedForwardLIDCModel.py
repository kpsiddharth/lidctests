...
def load_data():
    ...
    print ('Training Data = ', training_data[0][0:30])
    print ('Training Data = ', training_data[10][0:30])
...
def build_mlp_classifier(training_data, target_data):
    ...
    #mlp = MLPClassifier(solver='adam', verbose=True, max_iter=num_iter, validation_fraction=0.1, alpha=1e-5, hidden_layer_sizes=(1024, 1024, 256, 128, 6))
    print ('Training Data Shape = ', np.shape(training_data))
